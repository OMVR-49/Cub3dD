...
/*   Updated: 2024/03/26 23:26:25 by sacharai         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*create_newmap_line(int max_size_line)
{
	...
	j = 0;
	newmap_line = malloc(sizeof(char) * (max_size_line + 3));
...
char	*create_newmap_row(char **map, int max_size_line, int row_index)
{
	...
	newmap_row = malloc(sizeof(char) * (max_size_line + 3));
	k = 0;
...
char	**create_newmap(char **map, int max_size_line, int num_rows)
{
	...
	newmap = malloc(sizeof(char *) * (num_rows + 3));
	j = 1;
